...
1. Implementation Address: The implementation address is where proxy is delegating calls to.
2. Admin: This is the entity that has the authority to make changes to the proxy, especially when upgrading the contract.
